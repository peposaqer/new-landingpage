...
// Set initial text
document.getElementById('swiper-slide-text').textContent = slideTexts[document.documentElement.lang][0];

// Update slide texts when language changes
function updateSlideTexts(lang) {
  const currentIndex = swiper.realIndex;
  document.getElementById('swiper-slide-text').textContent = slideTexts[lang][currentIndex];
}
...
swiper.on('slideChange', function () {
  ...
  document.getElementById('swiper-slide-text').textContent = slideTexts[lang][idx];
});

// Update the setLanguage function to also update slide texts
const originalSetLanguage = setLanguage;
setLanguage = function(lang) {
  originalSetLanguage(lang);
  updateSlideTexts(lang);
};
